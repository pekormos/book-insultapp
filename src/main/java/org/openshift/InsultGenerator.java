	...
	public String generateInsult() { 
 		...
 		try { 
 			...
 			if (connection != null) { 
                ...
                String SQL_SLA_PENALTY = 
                "select p.SLA_NAME as sla_name, 
                ...
                String SQL_SLA_SOLUTION = 
                "select so.SOLUTION AS solution,	        
               ...
               String SQL_SLA_SERVICELEVEL =                  
               "select  se.SLA_NAME	AS sla_name,  
                ...
                querry_result += "Content of SLA_PENALTY: \n";
                querry_result += "SLA_NAME, LIMIT_DEV_MIN, LIMIT_DEV_MAX, PENALTY_REL, VALID_FROM, VALID_TO \n"
 				while (rs.next()) { 
                       querry_result +=  String.format("%s, %s, %s, %s, %s, %s \n", rs.getString("sla_name"), 
                ...
                querry_result += "Content of SQL_SLA_SOLUTION: \n";
                querry_result += "SOLUTION, RECORD_DATE, CUSTOMER, NUMBER_ACTIVE_SPS, CANCELLATION_DATE \n"
 				while (rs.next()) { 
                       querry_result =  String.format("%s, %s, %s, %s, %s \n", rs.getString("solution"), 
                ...
                querry_result += "Content of SQL_SLA_SERVICELEVEL: \n";
                querry_result += "SLA_NAME, SLA_TYPE, SLA_VERSION, SOLCOMMIT_FLAG, SPCOMMIT_VALUE, PROCESS_FLAG, VALID_FROM, VALID_TO \n"
 				while (rs.next()) {
                       querry_result +=  String.format("%s, %s, %s, %s, %s, %s, %s, %s \n", rs.getString("sla_name"), 
